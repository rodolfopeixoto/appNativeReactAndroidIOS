 ...
 */
 ...
 class appBaseNative extends Component {
    constructor(props) {
        super(props);
        this.state = {
            radio1 : true,
                    ...
                    <Modal
                        ...
                        <Card style={{paddingTop: 20}}>
                            ...
                            :  <CardItem cardBody style={{justifyContent: 'flex-start'}}>
                                ...
                                <Text>
                                    Type: <Text>{this.state.selectedItem.owner.type}</Text>
                                </Text>
                                <Text>
                                    Stars: <Text>{this.state.selectedItem.stargazers_count}</Text>
                                </Text>
                                <Text>
                                    Language: <Text>{this.state.selectedItem.language}</Text>
                                </Text>
                                <Text>
                                    Open Issues: <Text>{this.state.selectedItem.open_issues_count}</Text>
                                </Text>
                                <Text>
                                    Last Update: <Text>{this.state.selectedItem.updated_at.slice(0,10)}</Text>
                                </Text>
...
AppRegistry.registerComponent('appBaseNative', () => appBaseNative);
